...
export default function Header() {
  ...
  const desktopNavClassName = ({ isActive }: { isActive: boolean }) =>
    [
      'rounded-full px-3 py-2 text-[13px] whitespace-nowrap font-semibold transition-all duration-300',
      isActive
      ...
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          {!user ? (
            <Link
              to="/account"
              className="hidden items-center gap-2 rounded-full bg-slate-950 px-4 py-2 text-[13px] whitespace-nowrap font-bold text-white shadow-lg shadow-slate-200/50 transition-all duration-300 hover:-translate-y-1 hover:bg-primary-600 hover:shadow-primary-500/30 lg:inline-flex dark:bg-white dark:text-slate-950 dark:shadow-none dark:hover:bg-primary-300"
            >
